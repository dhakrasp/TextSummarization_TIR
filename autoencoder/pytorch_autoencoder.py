...
def trainEpochs(encoder, decoder, n_epochs, preprocessor, print_every=1000, plot_every=100, learning_rate=0.01):
    start = time.time()
    plot_losses = []
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        input_variable = target_variable = training_data[epoch - 1]
